...
void mint() async {
  ...
  var dynamicAddress = await promiseToFuture(signer.getAddress());
  String address = dynamicAddress.toString();
  double balance = double.parse(
          (await promiseToFuture(provider.getBalance(address))).toString()) /
      1.0e+18;
